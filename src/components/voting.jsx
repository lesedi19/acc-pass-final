      ...
      <header className="header">
        <div className="header_desk">
          <div className="container">
            <div className="logo">
              {/*<Link to="#">
                <img width="100%" src="https://upload.wikimedia.org/wikipedia/vi/3/30/Logo-NEU.PNG" width="100%" alt="Logo Digital Services" />
              </Link> */}
            </div>
            <ul>
      ...
      <div className="main">
        ...
        <div className="container">
          ...
          <div className="list-user">
            ...
            <div className="detail-user"  onClick={showAlert}>
              <div className="thumnail">
                <img width="100%" src="https://hoakhoisinhvienvietnam.1vote.vn/_next/image?url=https%3A%2F%2Fmedia-platform.1vote.vn%2Fthumbnails%2Fuploads%2FxUrn1%2F1703751034461.JPG&w=1920&q=75" />
              </div>
              <div className="content">
            ...
            <div className="detail-user"  onClick={showAlert}>
              <div className="thumnail">
                <img width="100%" src="https://hoakhoisinhvienvietnam.1vote.vn/_next/image?url=https%3A%2F%2Fmedia-platform.1vote.vn%2Fthumbnails%2Fuploads%2FxUrn1%2F1703753270738.JPEG&w=1920&q=75" />
              </div>
              <div className="content">
            ...
            <div className="detail-user"  onClick={showAlert}>
              <div className="thumnail">
                <img width="100%" src="https://hoakhoisinhvienvietnam.1vote.vn/_next/image?url=https%3A%2F%2Fmedia-platform.1vote.vn%2Fthumbnails%2Fuploads%2FxUrn1%2F1703755582821.JPG&w=1920&q=75" />
              </div>
              <div className="content">
            ...
            <div className="detail-user"  onClick={showAlert}>
              <div className="thumnail">
                <img width="100%" src="https://scontent.fhan3-5.fna.fbcdn.net/v/t39.30808-6/405414623_751026800400408_1391227485058402166_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=3635dc&_nc_eui2=AeE0yosvbXNQ2ian1pTVZYZTJAiczPu3JbMkCJzM-7clswi74MsJGWyz4oUbRlcThhQm3TEag2TSECKz2Ju84F0v&_nc_ohc=GiibUVWFnZEAX9NBAoE&_nc_ht=scontent.fhan3-5.fna&oh=00_AfCSilvwWOexauYBxDRujiI-y-pJm19x9AQutZbjY9Oy4w&oe=659DC3E0" />
              </div>
              <div className="content">
